...
namespace _2023_GC_A2_Partiel_POO.Level_2
{
    ...
    public class TypeResolver
    {
        ...
        {
            if (attacker == receiver || attacker == TYPE.NORMAL || receiver == TYPE.NORMAL){
                return 1.0f;
            }
            ...
            if ((attacker == TYPE.FIRE && receiver == TYPE.WATER) || (attacker == TYPE.GRASS && receiver == TYPE.FIRE) || (attacker == TYPE.WATER && receiver == TYPE.GRASS))
            {
                return 0.8f;
            }
            return 1.0f;
